...
// by Jeffrey the Compression Buttler
...
unsigned char table  [SEG_SIZE + 100000];
unsigned char table2 [SEG_SIZE + 100000];
unsigned int indices [SEG_SIZE + 100000];
char outfilename [255];

int number, origTotal, compTotal;

// Functions definitions 
void unBWT (unsigned char table[], unsigned char outTable[], int length, int &outsize);
void unMTF (unsigned char table[], unsigned char outTable[], int length, int &outsize);
void unARI (unsigned char table[], unsigned char outTable[], int length, int &outsize);
void unRLE (unsigned char table[], unsigned char outTable[], int length, int &outsize);
...
int uncompressFileFromArchive (char *filename, char *compFile, unsigned char *OutputTable)
{
    ...
    int size = 0, size2 = 0, files = 0, totalBytes = 0;
	...
	{
        printf ("[%s] Not a valid archive file\n ", filename);
        return -1;
    }
...
int readInt ( unsigned char table[], int index)
{
int number;
...
// RLE Decode
// ----------------------------
void unRLE( unsigned char table[], unsigned char outTable[], int size, int &outindex )
{
	int index = 0, count;
...
// Main unARI
void unARI (unsigned char table[], unsigned char table2[], int size, int &outsize)
{
